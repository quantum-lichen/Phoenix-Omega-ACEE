...
![Domain](https://img.shields.io/badge/Field-Physique%20de%20l'Information-blue)
...
```mermaid
graph TD
    A[Flux d'Information] --> B{Moteur de Frustration}
    B -- Cohérence --> C[Minima d'Énergie / Attracteurs]
    B -- Contradiction --> D[Énergie de Frustration Sémantique]
    C --> E[T-RAID: Stockage Topologique]
    D --> F[Analyse Topologique des Données - TDA]
